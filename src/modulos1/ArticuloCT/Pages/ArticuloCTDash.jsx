...
import TarjetaLinkAdd from '../components/TarjetaAddLink'
...
function ArticuloCTDash() {
  ...
  return (
    <MainAdmin tituloPagina={"Administracion Articulos"} asideContent={asideContent}>
        
        <div className='contenedorContenidoPagina' >
        <TarjetaLinkAdd />
        {filteredAndSortedData.map((item) => (
          <Tarjeta key={item.idArticulo} objetoArticulo={item} />
        ))}
        </div>
