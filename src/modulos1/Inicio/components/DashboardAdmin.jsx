...
const Dashboard = () => {
  const buttons = [
    ...
    { label: "Categorías de tatuajes", icon: <FaImages />, path: "/pages/CategoriasDash" },
    ...
    { label: "Cuidados de tatuaje", icon: <FaQuestionCircle />, path: "/pages/ArticuloCTDash" },
    { label: "Cotizaciones", icon: <FaCreditCard />, path: "/pages/adm" },
    { label: "Agenda de artistas", icon: <FaCalendarAlt />, path: "/pages/adm" },
