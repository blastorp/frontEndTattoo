...
import "../estilos/CategoriaDetails.css";
  ...
  return (
    <div>
      ...
      <main>
        ...
        <section>
          <h2>Descripcion: </h2>
          <p>{data.descripcionCategoria}</p>
        </section>

        
        <section>
        <h2>Quienes la dominan?</h2>
          {/* aqui iria la lista de Artistas que Manejan */}
        </section>
        <section>
        <h2>Ver nuestras Artes: </h2>
          {/*enlace a Galeria */}
        </section>
