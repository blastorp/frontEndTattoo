...
const CheckboxButton = ({ children, idIn }) => {
  return (
    <StyledWrapper>
      <div className="customCheckBoxHolder">
        <input type="checkbox" id={ idIn } name={ idIn } className="customCheckBoxInput" />
        <label htmlFor={ idIn } className="customCheckBoxWrapper">
